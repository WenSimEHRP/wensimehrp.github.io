...
like footnotes and linking to labels (like ```#link(<some-label>)```). Those could be, however, achieved by writing
custom counters and html elements. For example, this is the code of my custom implementation of the footnote system:
