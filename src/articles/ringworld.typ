...
Despite the fact that my native speak is Mandarin
#footnote[
  The written language is Chinese, and the spoken language is Mandarin.
...
], I've set most of my services
and devices' displaying language to English#footnote[Canadian English, of course.].
I have three reasons for doing so:

- Terminologies are (usually) easier to understand.#footnote[
    Ref.: #elink("https://www.zhihu.com/question/27877812")[Shandong Club-ness (robustness)].
    This does not stand for "鲁智深提着狼牙棒" or "Koreans in Shandong"
  ]
- Most pieces of software, at their initial design phase, did not consider non-latin
  text layout, or they've considered that, but did a poor job on it. I am picky on text layouts,
  and Chinese is not a latin language#footnote[
    That is only valid if you are not a Romanized Chinese educand from the
  ...
  ]. Putting Chinese text in a latin-oriented
...
- Similar to the previous problem, translations with variable text may also break
  Chinese grammar rules#footnote[
    If you don't know Chinese already, here is an example in English: try
  ...
  ]. Even if they don't break the grammar, the translation
  may still be a result of machine translation, unreviewed AI translation, or from
  a careless translator#footnote[
    ref: I mistranslated some string of a game once and some angry players got
